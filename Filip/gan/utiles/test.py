...
x = np.arange(512)
y = np.sin(2*np.pi*x/32 + x)
plt.plot(y) # doctest: +SKIP
plt.show()
coef, freqs=pywt.dwt(y,'db3', 'sp1')
plt.plot(coef) # doctest: +SKIP
plt.show() # doctest: +SKIP

plt.plot(freqs) # doctest: +SKIP
plt.show() # doctest: +SKIP


plt.plot(pywt.idwt(coef, freqs,'db3', 'sp1'))
plt.show() # doctest: +SKIP


plt.plot(pywt.idwt(coef, freqs,'db3', 'sp1') - y)
plt.show() # doctest: +SKIP
"""
