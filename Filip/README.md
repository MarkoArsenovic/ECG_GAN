...
Classificacion models, such as Linear Support Vector Machine, Linear Support Vector Machine with stochastic gradient descent and logistic regresion; are trained on the 80% of the selected dataset and tested on 20%.

The training dataset is extracted with synthetic data and it is added to training dataset. 
Diffrence in confusion matrix and metrics, like Accuracy, Recall, Precision, F1 score are measured.
